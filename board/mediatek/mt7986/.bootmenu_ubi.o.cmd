cmd_board/mediatek/mt7986/bootmenu_ubi.o := /home/hatetm/temp_data/sdk/openwrt-21.02/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/bin/aarch64-openwrt-linux-musl-gcc -Wp,-MD,board/mediatek/mt7986/.bootmenu_ubi.o.d -nostdinc -isystem /home/hatetm/temp_data/sdk/openwrt-21.02/staging_dir/toolchain-aarch64_cortex-a53_gcc-8.4.0_musl/bin/../lib/gcc/aarch64-openwrt-linux-musl/8.4.0/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -Wall -Werror -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -std=gnu11 -fshort-wchar -fno-strict-aliasing -fno-PIE -O2 -fno-stack-protector -fno-delete-null-pointer-checks -Wno-pointer-sign -Wno-stringop-truncation -Wno-array-bounds -Wno-stringop-overflow -Wno-maybe-uninitialized -fmacro-prefix-map=./= -g -fstack-usage -Wno-format-nonliteral -Wno-unused-but-set-variable -Wno-unused-variable -Wno-unused-label -Wno-unused-function -Werror=date-time -Wno-packed-not-aligned -I./board/mediatek/common -D__ARM__ -fno-pic -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -mgeneral-regs-only -fno-common -ffixed-x18 -pipe -march=armv8-a+crc -D__LINUX_ARM_ARCH__=8 -I./arch/arm/mach-mediatek/include    -DKBUILD_BASENAME='"bootmenu_ubi"'  -DKBUILD_MODNAME='"bootmenu_ubi"' -c -o board/mediatek/mt7986/bootmenu_ubi.o board/mediatek/mt7986/bootmenu_ubi.c

source_board/mediatek/mt7986/bootmenu_ubi.o := board/mediatek/mt7986/bootmenu_ubi.c

deps_board/mediatek/mt7986/bootmenu_ubi.o := \
    $(wildcard include/config/enable/nand/nmbm.h) \
    $(wildcard include/config/mtk/secure/boot.h) \
    $(wildcard include/config/env/is/nowhere.h) \
    $(wildcard include/config/env/mtd/name.h) \
...
board/mediatek/mt7986/bootmenu_ubi.o: $(deps_board/mediatek/mt7986/bootmenu_ubi.o)
